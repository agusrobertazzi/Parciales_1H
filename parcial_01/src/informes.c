...
/*
 * brief: Imprime los salones con más de cuatro arcades
...
/*
 * brief: Imprime los arcades con más de dos jugadores
 * param: Arcade* listArcade
 * param: Int lenArcade
 * param: Salon* listSalon
 * param: Int lenSalon
...
/*
 * brief: Detalla la información de un salón y la cantidad de arcades que contiene
 * param: Salon* listSalon
 * param: Int lenSalon
 * param: Arcade* listArcade
 * param: Int lenArcade
...
/*
 * brief: Lista los arcades que están enlazados al ID buscado
 * param: Arcade* listArcade
 * param: Int lenArcade
 * param: Salon* listSalon
 * param: Int lenSalon
	...
	if(listArcade != NULL && lenArcade > 0 && listSalon != NULL && lenSalon > 0 && id != FALSE)
	{
		...
		for(i = 0; i < lenArcade; i++)
		{
			if(listArcade[i].isEmpty == FALSE && listArcade[i].idSalon == id)
			{
				...
				{
				case 0:
					printf("Arcade #%d || %s || MONO || Jugadores: %d || Fichas máximas: %d || Juego: %s\n", listArcade[i].id, listArcade[i].country, listArcade[i].players, listArcade[i].maxAmount, listArcade[i].gameName);
					break;
				case 1:
					printf("Arcade #%d || %s || ESTERÉO || Jugadores: %d || Fichas máximas: %d || Juego: %s\n", listArcade[i].id, listArcade[i].country, listArcade[i].players, listArcade[i].maxAmount, listArcade[i].gameName);
					break;
				}
			}
		}
...
/*
 * brief: Imprime el salón con más cantidad de Arcades
 * param: Arcade* listArcade
 * param: Int lenArcade
 * param: Salon* listSalon
 * param: Int lenSalon
...
/*
 * brief: Calcula el valor que ganaría cada salón según el precio que le coloques
 * param: Arcade* list
 * param: Int len
 * param: Int id
 * param: Int value
